...
function move_navigation($navigation, $MQ) {
    ...
    $navigation.insertAfter(".site-header > .wrap > .logo")) : ($navigation.detach(), 
    $navigation.insertAfter(".site-header"));
}

function move_credit($site_info, $MQ) {
    $(window).width() >= $MQ ? ($site_info.detach(), $site_info.insertBefore(".site-footer .site-footer__links")) : ($site_info.detach(), 
...
$(document).ready(function() {
    ...
    var $L = 868, $menu_navigation = $("#site-nav"), $cart_trigger = $("#nav-cart-trigger"), $hamburger_icon = $("#hamburger-menu"), $lateral_cart = $(".nav-cart"), $shadow_layer = $("#shadow-layer");
...
function(factory) {
    ...
    Slick = function() {
        function Slick(element, settings) {
            ...
            _.instanceUid = instanceUid++, _.htmlExpr = /^(?:\s*(<[\w\W]+>)[^>]*)$/, 
            _.registerBreakpoints(), _.init(!0), _.checkResponsive(!0);
        }
        var instanceUid = 0;
        return Slick;
        ...
        if (_.options.dots === !0 && _.slideCount > _.options.slidesToShow) {
            for (dot = $("<ul />").addClass(_.options.dotsClass), 
        ...
        _.updateDots(), _.setSlideClasses("number" == typeof _.currentSlide ? _.currentSlide : 0), 
        ...
        _.options.responsive && _.options.responsive.length && null !== _.options.responsive) {
            ...
            _.refresh(initial)), triggerBreakpoint = targetBreakpoint) : (_.activeBreakpoint = targetBreakpoint, 
            "unslick" === _.breakpointSettings[targetBreakpoint] ? _.unslick(targetBreakpoint) : (_.options = $.extend({}, _.originalSettings, _.breakpointSettings[targetBreakpoint]), 
            initial === !0 && (_.currentSlide = _.options.initialSlide), 
            _.refresh(initial)), triggerBreakpoint = targetBreakpoint) : null !== _.activeBreakpoint && (_.activeBreakpoint = null, 
        ...
        originalSlides.removeAttr("style"), _.$slider.empty().append(originalSlides));
        ...
        $(".slick-cloned", _.$slider).detach(), _.$dots && _.$dots.remove(), 
        ...
        _.$slideTrack.detach(), _.$list.detach(), _.$slider.append(_.$slides)), 
        _.cleanUpRows(), _.$slider.removeClass("slick-slider"), 
        _.$slider.removeClass("slick-initialized"), _.unslicked = !0, 
        ...
        var _ = this;
        null !== filter && (_.$slidesCache = _.$slides, _.unload(), 
        _.$slideTrack.children(this.options.slide).detach(), 
        ...
        breakPoint = counter + _.options.slidesToScroll, counter += _.options.slidesToScroll <= _.options.slidesToShow ? _.options.slidesToScroll : _.options.slidesToShow; else if (_.options.centerMode === !0) pagerQty = _.slideCount; else for (counter = _.slideCount % _.options.slidesToShow == 0 ? counter : counter + 1; breakPoint < _.slideCount; ) ++pagerQty, 
        ...
        _.updateDots()), creation && _.$slider.trigger("init", [ _ ]), 
        ...
        var _ = this;
        _.paused = !1, _.options.autoplay = !0, _.autoPlay();
        ...
        _.options.infinite || (_.slideCount <= _.options.slidesToShow ? _.currentSlide = 0 : _.currentSlide > firstVisible && (_.currentSlide = firstVisible)), 
        ...
        if ("array" === $.type(responsiveSettings) && responsiveSettings.length) {
            ...
            for (breakpoint in responsiveSettings) if (l = _.breakpoints.length - 1, 
        ...
        _.registerBreakpoints(), _.setProps(), _.setupInfinite(), 
        _.buildArrows(), _.updateArrows(), _.initArrowEvents(), 
        _.buildDots(), _.updateDots(), _.initDotEvents(), 
        _.checkResponsive(!1, !0), _.options.focusOnSelect === !0 && $(_.$slideTrack).children().on("click.slick", _.selectHandler), 
        ...
        _.setSlideClasses(_.currentSlide), _.options.asNavFor && (navTarget = _.getNavTarget(), 
        navTarget = navTarget.slick("getSlick"), navTarget.slideCount <= navTarget.options.slidesToShow && navTarget.setSlideClasses(_.currentSlide)), 
        ...
        _.$slider.on("focus.slick blur.slick", "*", function(event) {
            ...
            setTimeout(function() {
                ...
                _.paused = !0) : (_.paused = !1, _.autoPlay()));
            }, 0);
        });
    }, $.fn.slick = function() {
...
$(".quick-view").on("click", function() {
    $(".product-card").show(), $("body").toggleClass("overlay");
}), $(".product-card__close").on("click", function() {
    $(".product-card").hide(), $("body").toggleClass("overlay");
});

/*
    Move the site-info to last on mobile
*/
var $site_info = $(".site-info"), $L = 868;

jQuery(document).ready(function($) {
    // move #site-navigation inside header on laptop
    // insert #site-navigation after header on mobile
    move_credit($site_info, $L), $(window).on("resize", function() {
        move_credit($site_info, $L);
    });
}), /** Set the size for horizontal scroll menu **/
$(document).ready(function() {
    var container_width, link_width;
    count = 0, container_width = 0, $(".nav a").each(function(index) {
        count++, link_width = parseInt($(this).width(), 10), 
